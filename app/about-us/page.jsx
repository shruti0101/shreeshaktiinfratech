      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 mb-5 md:py-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="bg-black text-white p-6 md:p-10 rounded-xl border-2 border-yellow-600 shadow-lg">
              <h2 className="text-2xl md:text-3xl font-bold mb-5 text-center">
                {product.name}
              </h2>
              <div className="grid grid-cols-2 gap-y-4 text-base md:text-lg">
              ...
              <div className="flex gap-4 mt-8 justify-center">
                <button className="bg-[#FAAC18] text-white font-semibold px-6 py-3 rounded hover:bg-[#e99b10] transition">
                  Inquiry
                </button>
                <button className="border bg-white border-[#FAAC18] text-[#FAAC18] font-semibold px-6 py-3 rounded hover:text-black transition">
                  Learn More
                </button>
              </div>
            </div>
